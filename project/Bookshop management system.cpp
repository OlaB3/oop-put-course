...
class Testing : public Interface
{
...
public:
    ...
    Book(Interface* test) : test_price(test) {}
    ...
    void Price() const
    {
        cout << "Price: " << test_price->getPrice() << endl;
    }
...
int main()
{
    ...
    do
    {
        ...
        cout << "0 - close system" << endl << "1 - See database" << endl << "2 - Add book" << endl << "3 - Open receipt" << endl << "4 - Change quantity" << endl << "5 - Testing" << endl;
        cin >> num;
        if (num < 0 || num > 5)
        {
